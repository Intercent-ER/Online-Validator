...
public class ValidatorServiceTest {
	...
	public void getOvTipoDocumentoById() {
		...
		assertNotNull(ordine.getValidatori());
		assertNotNull(ordine_1.getValidatori());
		assertEquals(ordine.getValidatori().size(), ordine_1.getValidatori().size());
		...
		assertNotNull(ddt.getValidatori());
		assertNotNull(ddt_1.getValidatori());
		assertEquals(ddt.getValidatori().size(), ddt_1.getValidatori().size());
	}
