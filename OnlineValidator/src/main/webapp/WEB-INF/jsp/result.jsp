        ...
        <div class="container main-container">
            <div class="row">
                <div class="col-xl-12 mt-3 pl-0 pr-0">
                    <span class="h2 mb-0">Rapporto validazione <small>(versione schematron ${versioneSchematron})</small></span>

                    <c:choose>
                        <c:when test="${ not empty assertDiValidazione}">
                            <c:choose>
                                <c:when test="${ not risultatoValido }"><h3 style="color:red">Risultato: il file
