<footer class="d-flex flex-column footer">
    <div class="container">
        ...
        <ul>
            ...
            <li>Assistenza tecnica: <a href="mailto:assistenzaPEPPOL@agid.gov.it">assistenzaPEPPOL@agid.gov.it</a></li>
        </ul>
    </div>
    <div class="footer-bottom-container">
        <div class="container">
            <a href="https://peppol.agid.gov.it/it/privacy">Privacy policy</a>
        </div>
    </div>
</footer>
</body>
