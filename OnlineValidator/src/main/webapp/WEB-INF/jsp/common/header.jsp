<header>
    <div class="header-column-container container">
        
        <a class="d-flex flex-column align-items-center header-peppol-logo"
        ...
        <div class="d-flex justify-content-center">
            <span class="title">Validazione documenti Peppol</span>
        </div>
